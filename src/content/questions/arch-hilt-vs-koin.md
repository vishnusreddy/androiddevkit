...
**Soundbite:** "Hilt/Dagger = compile-time, type-safe, codegen DI (catches errors at build, scales to big graphs, but more boilerplate); Koin = runtime, simple Kotlin DSL (fast to adopt, but errors appear at runtime). Hilt is the Android default; Koin shines for simplicity/KMP."

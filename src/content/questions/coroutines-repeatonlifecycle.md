...
**Soundbite:** "`repeatOnLifecycle(STARTED)` cancels flow collection in the background and restarts it in the foreground — the safe, non-wasteful way to collect UI flows."

...
**Soundbite:** "Composition decides *what*, layout decides *where*, drawing decides *how* — and reading state as late as possible (in layout/draw lambdas) avoids needless recomposition."

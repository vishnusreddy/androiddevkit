...
**Soundbite:** "Default flow is backpressured by suspension; `buffer` decouples producer/consumer keeping all values, `conflate` keeps only the latest, `collectLatest` keeps the latest *and* cancels stale work."

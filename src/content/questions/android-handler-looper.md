...
**Soundbite:** "A Looper loops over a thread's MessageQueue dispatching messages; a Handler posts/handles them. The main thread is a Looper thread — block it and you get an ANR; that's the model coroutines' `Dispatchers.Main` sits on top of."

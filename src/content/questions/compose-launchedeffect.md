...
**Soundbite:** "`LaunchedEffect` runs a coroutine scoped to composition; its keys decide when to cancel-and-restart — use `Unit` for once, a parameter to re-run on change."

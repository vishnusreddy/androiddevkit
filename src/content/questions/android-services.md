...
**Soundbite:** "Started/bound/foreground services exist, but background limits mean you use WorkManager for deferred work and coroutines for in-app async — Services (usually foreground) are only for immediate, ongoing, user-visible tasks."

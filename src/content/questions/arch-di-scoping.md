---
question: "How do you decide DI scopes? What happens if you over- or under-scope?"
topic: architecture
difficulty: senior
...
**Soundbite:** "Scope = instance lifetime/sharing. Over-scoping leaks memory and retains stale state; under-scoping duplicates instances and wastes work. App-wide expensive clients → `@Singleton`, cheap stateless → unscoped, lifecycle-bound state → the matching scope; clear session-scoped state on logout."

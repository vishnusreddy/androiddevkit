...
**Implications interviewers want you to connect:**
...
**Soundbite:** "Enter → recompose (many times, any order) → leave. `remember` and effects are scoped to that lifecycle, which is why composable bodies must be side-effect free."

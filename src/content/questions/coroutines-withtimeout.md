...
**Soundbite:** "`withTimeout` throws, `withTimeoutOrNull` returns null — both cancel the block cooperatively, so the work must be cancellable for the timeout to take effect."

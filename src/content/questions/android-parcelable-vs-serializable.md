...
**Soundbite:** "Parcelable is Android's fast, reflection-free IPC serialization — use `@Parcelize`; Serializable is slow reflection-based Java. And never pass large objects through a Bundle (1MB Binder limit) — pass an ID instead."

...
**Soundbite:** "Suspension is the compiler turning your function into a resumable state machine driven by a `Continuation` callback — sequential-looking code, non-blocking execution."

...
**Soundbite:** "Measure with Layout Inspector/compiler metrics on a release build, then fix the usual suspects: unstable params, reading state too early, allocations in composition, and missing list keys. Baseline Profiles for startup/scroll."

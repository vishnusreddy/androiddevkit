...
**Soundbite:** "The Application is a process-lifetime singleton created before everything else — good for DI, crash reporting, and app context, but keep `onCreate` lean and lazy-init SDKs, because it runs on every cold start and blocks the first frame."

...
**Soundbite:** "Facade = a simple unified API over a complex subsystem, hiding its parts. The Repository is the canonical Android facade (hiding network/DB/cache behind `observeX()`); just don't let a facade balloon into a God object."

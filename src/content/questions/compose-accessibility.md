---
question: "How do you handle accessibility in Compose? (semantics, content descriptions, merging)"
...
**Soundbite:** "Compose auto-builds a semantics tree; you add `contentDescription` for images, `semantics { role/stateDescription }` for custom controls, and `mergeDescendants` so composite components are announced as one — plus 48dp targets and `sp` text for scaling."

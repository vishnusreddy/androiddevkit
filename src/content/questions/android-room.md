...
**Soundbite:** "Room = compile-time-checked SQLite with Entities/DAOs/Database, coroutine `suspend` queries, and observable `Flow` results that make the database a single source of truth — plus real migrations."

...
**Soundbite:** "AAB is a publishing format Play uses to generate per-device split APKs (density/ABI/language), cutting download size and enabling on-demand feature modules. It's required on Play; the APK is what actually installs."

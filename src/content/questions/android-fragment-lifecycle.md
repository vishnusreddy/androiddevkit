...
**Soundbite:** "Fragment vs view lifecycle differ because a back-stacked fragment keeps its instance but destroys its view — always use `viewLifecycleOwner` for view-bound observers and clear ViewBinding in `onDestroyView`."

---
question: "Should each layer have its own model? (DTO vs Entity vs Domain vs UI model)"
topic: architecture
difficulty: senior
...
**Soundbite:** "Separate per-layer models (DTO/Entity/Domain/UI) decouple layers so a server or DB change doesn't ripple into the UI — at the cost of mappers and boilerplate. Use them where the layers genuinely differ; share a model when the app is simple."

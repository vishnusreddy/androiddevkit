...
**Soundbite:** "DataStore replaces SharedPreferences with a coroutine/Flow API, async transactional writes, error handling, and a typed (Proto) option — no main-thread I/O. Use DataStore for new key-value/config; Room for relational data."

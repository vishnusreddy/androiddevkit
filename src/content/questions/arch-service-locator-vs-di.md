...
**Soundbite:** "DI **pushes** dependencies in (explicit, testable, compile-time-checked); a Service Locator has the class **pull** them from a global registry (hidden dependencies, runtime failures, harder tests). Prefer DI; note that Koin is locator-flavored under a DI-like DSL."

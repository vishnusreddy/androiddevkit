...
tags: ["dsa", "coroutines", "kotlin", "jetpack compose", "system design", "fragment lifecycle"]
draft: false
---
...
- A problem-solving question involving a circle divided into nine equal sectors: how to calculate a rotation that stops the indicator exactly on the fourth sector, and how to retain the selected sector when an `Activity` is recreated after a configuration change
...
I wish the team at [Snapmint](https://www.linkedin.com/company/snapmintfinserv/) all the best.

_Shared by [Utkarsh Saxena on GitHub](https://github.com/utkarsh006). [View his LinkedIn profile](https://www.linkedin.com/in/utkarsh006/)._
